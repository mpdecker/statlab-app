...
describe('SEO calculator pages', () => {
  it('declares the milestone 82 statistical calculator suite', () => {
    expect(calculatorPages.map((page) => page.slug)).toEqual([
      ...
      'marked-point-pattern-cross-k-function',
      'spatial-kriging-interpolation-variance',
      'spatial-error-lag-regression',
      'confirmatory-factor-analysis-cfa-fit',
      'bifactor-model-omega-hierarchical',
      'latent-growth-curve-model',
      'egarch-exponential-volatility',
      ...
      'functional-pca-fpca',
      'functional-mean-covariance-surface',
      'dirichlet-process-mixture-model',
      'gaussian-mixture-model-bic-aic',
      'renewal-process-repairable-systems',
      'sequential-probability-ratio-test-sprt',
      'normal-tolerance-interval-one-sided',
      'three-parameter-logistic-irt-3pl',
      'samejima-graded-response-irt',
      'differential-item-functioning-dif',
      'dynamic-factor-model-dfm',
      'threshold-autoregressive-tar',
      'markov-switching-autoregression',
      'clayton-gumbel-copula-dependence',
      'tail-dependence-coefficient',
      'scad-smooth-clipped-absolute-deviation',
      'mcp-minimax-concave-penalty',
      'group-lasso-categorical',
      'scalar-on-function-regression',
      'wavelet-denoising-thresholding',
      'availability-block-diagram-ram',
      'accelerated-degradation-testing-adt',
      'exponentially-weighted-moving-average-spc-mean',
      'kuiper-test-circular-distributions',
      'mood-test-scale-homogeneity',
      'ansari-bradley-scale-test',
      'siegel-tukey-rank-dispersion',
      'multinomial-logistic-regression-odds',
      'ordinal-logistic-regression-polytomous',
      'cox-proportional-hazards-schoenfeld',
      'kaplan-meier-log-rank-power',
      'spatial-bivariate-morans-i',
      'lisa-local-morans-i',
      'point-process-l-function',
      'cross-correlation-function-ccf',
      'hahn-hasbrouck-market-microstructure',
      'bivariate-garch-dcc',
      'partial-least-squares-pls-fit',
      'principal-component-regression-pcr',
      'conjoint-analysis-part-worth-utility',
      'multidimensional-scaling-mds-stress',
      'correspondence-analysis-inertia',
      'canonical-variate-analysis-cva',
      'bivariate-normal-cdf-elliptical',
      ...
      't-sne-kl-divergence-embedding',
      'umap-fuzzy-simplicial-set',
      'spatial-autocorrelation-bivariate-geary',
      'directional-variogram-anisotropy',
      'spatiotemporal-kriging-interpolation',
      'realized-kernel-volatility-microstructure',
      'threshold-garch-tarch-zakoian',
      'fractionally-integrated-arima-arfima',
      'propensity-score-matching-psm-att',
